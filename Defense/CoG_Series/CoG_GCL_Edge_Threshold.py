    ...
    def fit(self, x, adj, labels, idx_train, idx_val=None, idx_test=None, epochs=200, iteration=20):
        ...
        for i in trange(iteration):
            for epoch in range(epochs):
                ...
                # fake_edge_weight = fake_edge_weight.sigmoid()
                if epoch % 20 == 0:
                    print(fake_edge_weight.min(), fake_edge_weight.max())

                loss = self.contrast(real_edge_index, real_edge_weight, fake_edge_index, fake_edge_weight)
